...
public static class ImpulseBurn
{
    ...
    public static SatTLE changeTLEPostBurn(SatState stateNew, SatTLE satOrig)
    {
        var keplerElems = OrbitalUtils.StateToKepler(stateNew);
    ...
    private static string Pad(string value, char padChar, int width, bool rightJustify)
    {
        ...
        {
            // You can throw instead if you prefer strictness.
